<?php get_header(); ?>
        ...
        <?php while (have_posts()) : the_post(); ?>
        	...
        	<div class="column span-11 first">
				...
				<div class="bigcaption"><?php if ( !empty($post->post_excerpt) ) the_excerpt(); // this is the “caption” ?></div>
            	
				<div class="imgnav">
					<div class="prvimg">
						<?php tma_next_image_link('<h4 class="gall">Previous Image</h4>') ?>
					</div>

					<div class="nxtimg">
						<?php tma_previous_image_link('<h4 class="gall">Next Image</h4>'); ?>
					</div>
				</div>
